...
public class DMRConnection {
	  ...
	  private int port = 9999;                      //Make sure that port offset is added in managemt port (if any)
	  private String user = "admin";                //replace it with management username created with the help of add-user.sh
	  private String password = "Password640!";           //respective password 
	...
	private final ModelControllerClient createClient(final InetAddress host, final int port, final String username, final String password) {
