 ...
 */
public class SimpleUsernameOnlyLoginModule extends UsernamePasswordLoginModule {
	//public class SimpleUsernameOnlyLoginModule extends org.jboss.security.auth.spi.AbstractServerLoginModule {
    ...
    /**
     * (required) The SimpleUsernameOnlyLoginModule modules compares the result of this
...
//        return super.validatePassword(encryptedInputPassword, expectedPassword);
    	...
    	// TODO - ALWAYS RETURNING TRUE Ie. never check password
    	return true;
    }
    ...
    protected Group[] getRoleSets() throws LoginException {
        ...
        try {
            ...
            group.addMember(new SimplePrincipal("item-receiver"));
