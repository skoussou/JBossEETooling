helloworld-ws-2way-ssl: Hello World JAX-WS Web Service (Modified to be authenticated with 2-way SSL see ssl-materals folder)
==================================================
Author: Lee Newson  
Level: Beginner  
Technologies: JAX-WS  
...
Stelios Kousouris Modification: See the ssl-materials folder where the material and instructions to configure the server side and a client (JDV in this case) to run 2-way SSL authentication
